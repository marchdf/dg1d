...
class SensorTestCase(unittest.TestCase):
        ...
        def test_sensing_euler(self):
                ...
                gamma = 1.4
                pratio = 20
                Ms = np.sqrt((gamma+1)/(2.0*gamma)*pratio + (gamma-1)/(2.0*gamma))
                ...
                rho = np.array([rho2,rho2,rho2,rho2,rho1,rho1,rho1,rho1,rho1,rho1,rho1,rho0,rho0,rho0])
                u   = np.array([  u2,  u2,  u2,  u2,  u1,  u1,  u1,  u1,  u1,  u1,  u1,  u0,  u0,  u0])
                p   = np.array([  p2,  p2,  p2,  p2,  p1,  p1,  p1,  p1,  p1,  p1,  p1,  p0,  p0,  p0])
