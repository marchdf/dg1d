...
parser = argparse.ArgumentParser(
    description='A simple plot tool for the one-dimensional shock tube problems')
...
parser.add_argument('-d', '--directory', dest='fdir',
                    help='Directory containing data', type=str, required=True)
