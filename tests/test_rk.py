...
class RKTestCase(unittest.TestCase):
    ...
    def test_adjust_for_output0(self):
        """Given dt=0.1, t=1, tf = 2, tout=1.5, does adjust_for_output do the right thing?"""
    ...
    def test_adjust_for_output1(self):
        """Given dt=0.1, t=1, tf = 2, tout=1.01, does adjust_for_output do the right thing?"""
    ...
    def test_adjust_for_output2(self):
        """Given dt=0.1, t=1, tf = 1.001, tout=1.1, does adjust_for_output do the right thing?"""
